...
//   var retweetText = "";
//   if (isRetweet) {
//     retweetText = `<a href ="/profile/${retweetedBy}"><span>
...
function createPostHtml(postData, largeFont = false) 
{
    ...
    if (postData == null || typeof postData !== "object") {
        return alert("Invalid Post object"); // Return an error for invalid postData
      }
      ...
      if (!postData || typeof postData !== "object" || !postData.postedBy) {
      ...
      if (postedBy._id === undefined) {
        return console.log("User object's _id property is undefined");
      }
